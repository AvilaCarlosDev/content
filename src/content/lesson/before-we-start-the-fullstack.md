...
- How to include a separate CSS stylesheet in your website using the `<link>` tag.
- How to override or enhance the way that HTML tags look and behave by using CSS selectors and rules, for example:
  ...
  - The simplest things like changing text color and manipulating fonts (size, family, etc). 
