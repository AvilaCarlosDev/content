...
- Meaningful and clear variable names help everyone understand what goes in said variable.
...
- The name of a function must describe the reason for using the function clearly and briefly.
